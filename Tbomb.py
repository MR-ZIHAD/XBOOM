...
def update():
    try:
        ...
        toolVersion = "MR-ZIHAD"
    
    try:
        mainVersion = requests.get("https://raw.githubusercontent.com/MR-ZIHAD/XBOOM/main/.version").text
    except:
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mXBOOM\n")
        time.sleep(0.6)
